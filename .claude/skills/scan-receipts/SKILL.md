---
name: scan-receipts
description: Scan the "2026 Receipts" Google Drive folder for new receipts/invoices not yet recorded in data/expenses.xlsx, extract their fields, and add rows for anything new — skipping anything already recorded and flagging anything unclear. This is Ledger's recipe for the regular job "Scan my Receipts folder."
---
...
- Source folder: Google Drive folder **"2026 Receipts"**, id `15_-nllcLAoIy9bqyeC2VIXGIxv7ToQ7P`.
...
1. List the folder's files: `mcp__claude_ai_Google_Drive__search_files` with query
   `parentId = '15_-nllcLAoIy9bqyeC2VIXGIxv7ToQ7P'`.

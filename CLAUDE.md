...
- Receipts source: Google Drive folder **"Receipts"**
  (id `YOUR_DRIVE_FOLDER_ID`). Files there are often **consolidated** — one PDF or
...
- **Scan for receipts/invoices**: look at the "Receipts" Drive folder for new or
